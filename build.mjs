...
{ name: '#903a 时段变动失效已抽当前时刻（不失效＝改完时辰区间仍显示老时辰旧时刻到冷却结束，「设置的时间与显示的时辰对不上」复发）', file: 'js/cjian.js', needle: 'function invalidateTaTime(cid) { try { const s = storeOf(cid); if (s) s.remove(\'cjian-ta-time\'); } catch (e) {} }' },
  ...
  { name: '#900j 警示弹窗正文本身染红（删回只换底色＝人话提醒与普通说明同色，用户看不懂在提醒什么）', file: 'css/base.css', needle: '.modal.modal--warn .modal-static { color:#c92a1f;' },
  { name: '#900k 深色主题把警示正文提亮成亮红（删＝深底上沿用 #c92a1f 约 2.7:1 看不清，深色用户又看不到重点）', file: 'css/dark.css', needle: '[data-theme="dark"] .modal.modal--warn .modal-static { color:#ff8a7a;' },
