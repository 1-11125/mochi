...
} catch (__e) { try { console.error("[JS] dream-free.js", __e && __e.message || __e); } catch (x) {} if (window.__jsErrors) window.__jsErrors.push("[dream-free.js] " + String(__e && __e.message || __e)); } })();