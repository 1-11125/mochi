...
} catch (__e) { try { console.error("[JS] data-backup.js", __e && __e.message || __e); } catch (x) {} if (window.__jsErrors) window.__jsErrors.push("[data-backup.js] " + String(__e && __e.message || __e)); } })();