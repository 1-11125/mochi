...
} catch (__e) { try { console.error("[JS] ta-mood-data.js", __e && __e.message || __e); } catch (x) {} if (window.__jsErrors) window.__jsErrors.push("[ta-mood-data.js] " + String(__e && __e.message || __e)); } })();