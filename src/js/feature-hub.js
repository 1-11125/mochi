...
(function () {
  ...
  const HUB = [
    ...
    { g: '系统与设置', items: [
      ...
      { n: '卡顿自检 · 一键优化（手机卡顿怎么办）', d: '手机（安卓 / iPhone）持续卡顿的主因是数据体积（图片内联存储）：实测占得最多的是聊天记录，其次是字卡库。本项扫描分级并一键预热修复，不删任何数据；按顺序优化的完整清单见本行「功能说明」', k: '卡顿 卡 很卡 优化 性能 流畅 预热 图片 聊天记录 字卡库 内存 白屏 重载 变慢', go: ['#row-perf-optimize'] },
