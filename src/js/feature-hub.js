...
(function () {
  ...
  const HUB = [
    ...
    { g: '互动与心意', items: [
      ...
      // #790/#791 功能大全补全：换位提醒三开关 + 摸鱼抓包浮字开关的搜索入口
      ...
      { n: '摸鱼抓包', d: 'TA 摸鱼值上涨时桌面飘「摸鱼浮字」，6 秒内点「点我抓包」双方摸鱼值翻倍＋TA 害羞回应；抓包记录在主页「摸鱼抓包」', k: '摸鱼 抓包 浮字 小字 点我抓包 抓包成功 摸鱼值 翻倍 记录', where: 'TA 摸鱼时桌面自动飘字；记录看主页「摸鱼抓包」' },
