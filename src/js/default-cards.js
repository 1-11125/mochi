...
// 这些字卡不是聊天通用回复，是触发对应功能时联系人才会使用。
  ...
  const DCF_DESC = {
    ...
    piggy: '【存钱罐】存钱/取款后，联系人发来的关心/追问（含「取款关心」），可内联回一句；也控制 TA 偶尔往存钱罐「塞心意币」并发的聊天系统消息。\n概率 = 取款追问 / 塞币彩蛋出现的概率，0% = 不追问、也不塞币。',
    ...
    memo: '【备忘提醒】你有未完成的备忘时，联系人每隔一段时间（约 4 分钟一掷、命中才发）在聊天里催一件，带「备忘提醒」标签；同一天最多提醒一次、隔 2 天才再催、深夜静默。\n本概率 = 在备忘页自带的「备忘提醒」开关/概率之上是否放行：100% = 保持原节奏，0% = 完全不催备忘。\n备忘页里自己的开关仍独立有效。',
    ask: '【TA主动提问】联系人在聊天里主动发起的问题卡：关心询问 / 小问题 / 好奇卡片 / 互动 / 吐槽，带你作答选项。每类自带触发概率（默认 5%）且各带冷却，任意一问后 60 分钟内不再自动触发。\n本概率 = 在那套概率/闸门之上是否统一放行：100% = 保持原节奏，0% = 完全不主动提问。\n不影响查岗（查岗走自己的「跨桌面查岗」）。'
  };
